...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const map05 = document.querySelector('.map05');
    const map06 = document.querySelector('.map06');
        ...
        pin.addEventListener("click", function() {
            ...
            switch (pinClass) {
                ...
                case "pin03":
                    ...
                    break;
                case "pin04":
                    moveHaeroTo(300, 80); // Adjusted position for pin04
                    moveToroTo(320, 280); // Adjusted position for pin04
                    break;
                case "pin05":
                    moveHaeroTo(170, 80); // Adjusted position for pin05
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const images = [
        'url("https://ifh.cc/g/aFdvZT.jpg")',
        'url("https://ifh.cc/g/ml0FQm.jpg")',
        'url("https://ifh.cc/g/aoccO3.png)',
